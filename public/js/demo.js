...
function showVizualization(theProfile) {
  ...
  $('.translate-btn').click(function(){
    $('.translate-btn').hide();
    $('.loading').show();
    var originalText = $('.summary-div').text();
    ...
    $.ajax(restAPICall)
        .done(function(data) {
            $('.loading').hide();
            $('.summary-div').text(data['translations'][0]['translation']);
        })
  ...
  */
  ...
  $('.speak-btn').click(function(evt) {
    var text = $('.summary-div').text();
